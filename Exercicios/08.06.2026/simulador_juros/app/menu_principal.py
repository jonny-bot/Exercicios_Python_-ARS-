...
from .telas.reserva_emergencia import ReservaEmergencia
...
class MenuPrincipal(QWidget):
    ...
    def _setup_ui(self):
        ...
        menu_layout.addLayout(self._build_section([
            ...
            ("🦺​ Reserva de Emergência", "#665600", lambda: self._switch_page(self.reserva_emergencia))
        ]))
        ...
        self.reserva_emergencia = ReservaEmergencia(voltar_callback=self.show_menu, dark_mode=self.dark_mode)  # NOVO

        for tela in [
            self.gastos, self.numero_magico, self.metas,
            self.simulador, self.milhao, self.simples,
            self.reserva_emergencia  # NOVO
        ]:
    ...
    def apply_theme(self):
        ...
        self.reserva_emergencia.atualizar_tema(self.dark_mode)
