...
class PrimeiroMilhao(QWidget):
    """Tela do cálculo do primeiro milhão.

    Simula o saldo acumulado com aporte mensal e juros compostos até atingir R$ 1.000.000.
    """
    ...
    def initUI(self):
        ...
        # Ajusta colunas para ocupar todo o espaço disponível
